...
int32_t dmabuff_L[BUFF_SIZE] __attribute__((section(".ram_d2")));
int32_t dmabuff_R[BUFF_SIZE] __attribute__((section(".ram_d2")));

float32_t hanning_window[SAMPLES] __attribute__((section(".dtcm")));
float32_t a_weighting_table[SAMPLES / 2] __attribute__((section(".dtcm")));
float32_t hanning_window_energy = 0.0f;

float32_t fft_inputL[SAMPLES] __attribute__((section(".dtcm")));
float32_t fft_inputR[SAMPLES] __attribute__((section(".dtcm")));
float32_t fft_outputL[SAMPLES] __attribute__((section(".dtcm")));
float32_t fft_outputR[SAMPLES] __attribute__((section(".dtcm")));
float32_t fft_magnitudesL[SAMPLES / 2] __attribute__((section(".dtcm")));
float32_t fft_magnitudesR[SAMPLES / 2] __attribute__((section(".dtcm")));
